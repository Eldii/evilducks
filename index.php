    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="collapseEx2">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href='#videos'>CSGO School</a>
          </li>
          <!-- <li class="nav-item">
...
<video autoplay loop id="bgvid">
  ...
  <div class="section carousel-caption active" id="home">
    ...
    <div class="carousel-caption section" id="bootcamp">
      ...
      <!--Demos-->
      <a  name="videos"></a>
      <div class="carousel-caption section" id="videos">

    <!--Section heading-->
    <h1 class="section-heading h1 pt-4">CSGO School</h1>
    <!--Section description-->
            ...
            <div class="carousel-item active">
                ...
                <div class="col-md-4">
                    ...
                    <div class="card card-cascade narrower">
                      <iframe width="100%" height="400" src="https://www.youtube.com/embed/mQWeMPdVdkM" frameborder="0" allowfullscreen></iframe>
