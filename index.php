        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5 col-sm-6">
                    <hr class="section-heading-spacer">
                    <div class="clearfix"></div>
                    <h2 class="section-heading">Exemple de tableau recapitulant les rencontres</h2>
                    <table class="table">
                        <thead>
                          <tr>
                            <th>Pseudo1</th>
                ...
                <div class="col-lg-5 col-lg-offset-2 col-sm-6">
                    <hr class="section-heading-spacer">
                    <div class="clearfix"></div>
                    <h2 class="section-heading">Exemple de tableau recapitulant le classement de l'ensemble des rencontres</h2>
